...
def sgd_momentum(w, dw, config=None):
    ...
    # Tried to implement like Gil showed in class and got bad results, 
    # had to use stanford implementation to pass the level. 
    # Not so sure why :\
...
def adam(w, dw, config=None):
    ...
    next_w = w - config['learning_rate'] * first_unbias / (np.sqrt(second_unbias) + 1e-7)
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
